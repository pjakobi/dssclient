...
/**
 * <p>Classe Java pour VerifyManifestResultsType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="ManifestResult" type="{http://docs.oasis-open.org/dss-x/ns/core}ManifestResultType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class VerifyManifestResultsType {
    ...
    protected List<ManifestResultType> manifestResult;
     ...
     * {@link ManifestResultType }
     * 
     * 
     */
    public List<ManifestResultType> getManifestResult() {
        if (manifestResult == null) {
            manifestResult = new ArrayList<ManifestResultType>();
        }
